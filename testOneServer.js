...
$( document ).ready(function() {
    ...
    exec((app.getAppPath() + '/node_modules/selenium-standalone/bin/selenium-standalone start -- -role node -hub http://localhost:4444/grid/register -port 5557'), (error, stdout, stderr) => {
  if (error) {
